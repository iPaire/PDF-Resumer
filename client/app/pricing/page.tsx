...
export default function PricingPage() {
  ...
  // Detectăm dimensiunea ecranului la încărcare și la redimensionare
  useEffect(() => {
    const checkIfMobile = () => {
      setIsMobile(window.innerWidth < 768);
    };
    
    // Verifică la încărcarea inițială
    checkIfMobile();
    
    // Ascultă de evenimentele de redimensionare
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {isMobile ? (
          <div className="space-y-6">
            ...
            <div className="bg-white shadow-lg rounded-xl p-5 border border-gray-300">
              ...
              <button className="w-full py-2 px-4 rounded-lg border border-gray-300 text-gray-800 font-medium 
            ...
            <div className="bg-white shadow-lg rounded-xl p-5 border-2 border-blue-500">
              ...
              <button className="w-full py-2 px-4 rounded-lg border border-blue-500 text-blue-500 font-medium 
            ...
            {/* Plan Premium - versiune mobil */}
            <div className="relative">
              <div className="absolute -top-3 right-4 bg-yellow-500 text-white px-3 py-1 rounded-lg font-bold z-10
                              transform rotate-3 shadow-md text-xs">
                POPULAR
              </div>
              ...
              <div className="bg-white shadow-xl rounded-xl p-5 border-2 border-yellow-500">
                ...
                <button className="w-full py-2 px-4 rounded-lg border border-yellow-500 text-yellow-500 font-medium 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Plan Standard - versiune desktop */}
            ...
            {/* Plan Premium - versiune desktop */}
            <div className="relative md:col-span-2">
              <div className="absolute -top-3 right-4 bg-yellow-500 text-white px-4 py-2 rounded-lg font-bold z-10
        ...
        <div className="mt-10 sm:mt-12 text-center text-gray-600">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 text-xs sm:text-sm">
            <span className="bg-gray-100 px-2 py-1 sm:px-3 sm:py-1 rounded-full">Stocare nelimitată</span>
